...
function exp_PROP_1rule0_eval_expression(context) {
    // "PROPRIETÁ" = 'SEM PROPRIETÁRIO'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PROPRIETÁ')  == 'SEM PROPRIETÁRIO');
    } else {
        return (feature.get('PROPRIETÁ')  == 'SEM PROPRIETÁRIO');
    }
}
...
function exp_PROP_1rule1_eval_expression(context) {
    // "PROPRIETÁ" = 'PREFEITURA'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('PROPRIETÁ')  == 'PREFEITURA');
    } else {
        return (feature.get('PROPRIETÁ')  == 'PREFEITURA');
    }
}